    ...
    return (
      <div className="relative z-10 bg-[#141414] p-10 lg:p-20 flex flex-col gap-6">
        <div className="text-2xl lg:text-4xl font-bold text-justify">
          ...
          oportunidades de colaboração que vão de joint ventures a contratos de
          fornecimento. Juntos, podemos forjar um futuro onde a excelência e a
          responsabilidade se encontram.
        </div>
